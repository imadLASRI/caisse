<nav class="navbar navbar-default navbar-fixed-top navbar-top">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav @if (__('voyager::generic.is_rtl') == 'true') navbar-left @else navbar-right @endif">
            ...
            @if( route('voyager.dashboard') != Request::url() )
                <li class="caisse-dispo">
                    <span class="text-secondary">Caisse disponible : </span>
                    <span class="text-success"><b>{{ number_format($sharedCaisse,2,"."," ") }} Dhs</b></span>
                </li>
            @endif
